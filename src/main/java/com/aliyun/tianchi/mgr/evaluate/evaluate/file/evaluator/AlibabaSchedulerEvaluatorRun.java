...
public class AlibabaSchedulerEvaluatorRun {
    ...
    public static void main(String[] args) throws Exception {
        ...
        evaluator.init(new BufferedReader(new InputStreamReader(problem, Charset.forName("UTF-8"))));
        double score = evaluator.evaluate(new BufferedReader(new InputStreamReader(result, Charset.forName("UTF-8"))));
